...
- **Все участники**:
  ...
  - Определение ответственных за каждую область проекта.
...
- **Python Backend**:
  ...
  - Определение REST API для взаимодействия с фронтендом на Unity, включая протоколы аутентификации и обработки данных.
  - Установление основных зависимостей для серверной части проекта, таких как Flask, SQLAlchemy и другие необходимые библиотеки.
...
- **Python Backend**:
  - Окончательная настройка баз данных с учётом всех полей, необходимых для работы с пользователями, их визитами и вопросами-ответами.
